    ...
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-950/90 backdrop-blur-md border-b border-gray-800 px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#" className="text-gray-400 hover:text-white transition text-sm">Services</a>
          <a href="#" className="text-gray-400 hover:text-white transition text-sm">Réalisations</a>
          <a href="#" className="text-gray-400 hover:text-white transition text-sm">Tarifs</a>
      ...
      {open && (
        <div className="fixed inset-0 z-40 bg-gray-950 flex flex-col items-center justify-center gap-8">
          <a href="#" onClick={() => setOpen(false)} className="text-white text-3xl font-bold">Services</a>
          <a href="#" onClick={() => setOpen(false)} className="text-white text-3xl font-bold">Réalisations</a>
          <a href="#" onClick={() => setOpen(false)} className="text-white text-3xl font-bold">Tarifs</a>
