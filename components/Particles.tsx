...
export default function Particles() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particles.forEach((p) => {
        ...
        ctx.fillStyle = `rgba(245, 165, 35, ${p.opacity})`;
        ctx.fill();
      });
  ...
  return (
    <div className="fixed inset-0 z-0 bg-gray-950 overflow-hidden">
      {/* Orbes lumineux */}
      <div className="glow-orb-1 absolute top-1/4 left-1/4 w-125 h-125 bg-amber-500/10 rounded-full blur-[120px]" />
      <div className="glow-orb-2 absolute bottom-1/4 right-1/4 w-100 h-100 bg-amber-600/10 rounded-full blur-[120px]" />
      {/* Grain */}
      <div
