    ...
    <section id="services" className="py-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <AnimatedSection>
            <div className="bg-gray-900/50 rounded-2xl p-8 border border-gray-800 hover:shadow-xl hover:-translate-y-2 hover:border-amber-500/50 transition-all duration-300 group">
