    ...
    <section className="py-24 px-6">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <AnimatedSection>
          ...
          <h2 className="font-serif text-4xl md:text-5xl font-bold mb-6 text-white">Enguerrand Bourghelle</h2>
          ...
          <button onClick={scrollToContact} className="bg-amber-500 text-black px-6 py-3 rounded-xl font-medium hover:bg-amber-400 transition">
            Me contacter
          </button>
        </AnimatedSection>
        <AnimatedSection>
          <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-10 text-white">
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-4">
                <span className="font-mono text-amber-500 text-2xl font-bold">01</span>
                <p className="text-gray-300">Site livré en 10 jours</p>
              </div>
              <div className="flex items-center gap-4">
                <span className="font-mono text-amber-500 text-2xl font-bold">02</span>
                <p className="text-gray-300">Tarif transparent — devis gratuit sous 24h</p>
              </div>
              <div className="flex items-center gap-4">
                <span className="font-mono text-amber-500 text-2xl font-bold">03</span>
                <p className="text-gray-300">SEO local inclus — visible sur Google</p>
              </div>
              <div className="flex items-center gap-4">
                <span className="font-mono text-amber-500 text-2xl font-bold">04</span>
